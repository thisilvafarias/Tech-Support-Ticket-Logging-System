...
import javax.swing.table.DefaultTableModel;
	...
	public class deleteTicketWindow extends JFrame {
        ...
        JMenu Help = new JMenu("Help");
            ...
            JButton sav = new JButton("Delete this ticket");
		...
		public deleteTicketWindow(String TicketNumber) {
		...
		private class ButtonHandler implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(deleteTicketWindow.this,
            ...
            // Buttons 
            	...
            	Statement stmt = null;
        				try {
        					...
        					stmt.execute("DELETE FROM Ticket where TicketNumber = '"+tk+"';");
        					
        					JOptionPane.showMessageDialog(Panel,"The ticket " +tk+" was successfully Deleted");
