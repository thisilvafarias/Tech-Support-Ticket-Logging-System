...
import javax.swing.table.DefaultTableModel;
	...
	public class closeTicketWindow extends JFrame {
        ...
        JMenu Help = new JMenu("Help");
            ...
            JButton CloseTicket = new JButton("Close this Ticket");
		...
		public closeTicketWindow(String TicketNumber) {
	        ...
	        CloseTicket.addActionListener(Handler);
	        quit.addActionListener(Handler);
	        
	        CloseTicket.setActionCommand("CloseThisTicket");
		...
		private class ButtonHandler implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(closeTicketWindow.this,
            ...
            // Buttons 
				else if (e.getActionCommand().equals("CloseThisTicket")) {
            	System.out.println("The ticket "+tk+ "was successfully Closed");
            	...
            	Statement stmt = null;
        				try {
        					...
        					String nameT =null;
        					String status = "Close";
        					String ClosedOn = currentTime;
        					
        					conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1/TicketLoggingSystem?user=root&password=");
        				    stmt = conn.createStatement();
        				    
        					stmt.execute("UPDATE Ticket SET Status ='"+status+"', ClosedOn ='"+ClosedOn+"' where TicketNumber = '"+tk+"';");
        					//stmt.execute("UPDATE Ticket SET Status ='"+status+"' where TicketNumber = '"+tk+"';");
        				    //  stmt.execute("UPDATE Ticket SET ClosedOn ='"+ClosedOn+"' where TicketNumber = '"+tk+"';");
        					
        					JOptionPane.showMessageDialog(Panel, "New ticket was successfully Closed");
